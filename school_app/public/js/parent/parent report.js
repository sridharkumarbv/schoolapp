function parentReport($scope, $http, $location, $locale, $sce)  {
...
$scope.parentviewreport=function(){
...
$http.post("/parentviewreport", data).success(function(data, status, headers, config){
   ...
   if (status == 200) {
    ...
    $scope.showReport=false;
			...
			$scope.error = true;
   $scope.showReport=false;
			$scope.errorMessage = "No Report Found in the selected subject.";
